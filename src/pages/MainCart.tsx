...
return (
  ...
  <div>
    ...
    <div className="name-city bg-black opacity-60  block relative text-center border-white w-60 text-2xl rounded-3xl mx-auto my-0 border-2 text-white top-8">{name}</div>
